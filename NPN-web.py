...
# CUDA_VISIBLE_DEVICES=7  python main_v3.py --warmup-epoch 200 --epoch 300 --batch-size 128 --lr 0.05 --warmup-lr 0.05  --noise-type symmetric --closeset-ratio 0.2 --lr-decay cosine:200,5e-5,300 --opt sgd --dataset cifar100nc --topk 5 --log main_v3
# CUDA_VISIBLE_DEVICES=7  python mian_web.py --warmup-epoch 30 --epoch 100 --batch-size 64 --lr 0.005 --warmup --lr 0.005  --lr-decay cosine:30,1e-5,100 --opt sgd --dataset web-aircraft --model Resnet18